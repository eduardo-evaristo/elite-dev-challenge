const footerColumns = [
  {
    title: 'Plataforma',
    links: ['Sobre', 'Como funciona', 'Termos de uso', 'Privacidade'],
  },
  {
    title: 'Para organizadores',
    links: ['Criar evento', 'Painel', 'Preços', 'Ajuda'],
  },
  {
    title: 'Atendimento',
    links: ['Central de ajuda', 'Fale conosco', 'Reembolsos'],
  },
];
    ...
    <footer className='flex flex-col gap-8 bg-surface px-20 py-12'>
      ...
      <div className='flex items-center justify-between'>
        <p className='text-xs text-muted-foreground'>
          © 2025 Guichê. Todos os direitos reservados.
        </p>
      </div>
      ...
      <div className='flex items-center justify-between gap-4 py-4'>
        <div className='flex items-center gap-2'>
          ...
          <div className='h-5 w-8 rounded-sm bg-[#E31837]' />
          <div className='h-5 w-8 rounded-sm bg-[#003087]' />
          <div className='h-5 w-8 rounded-sm bg-[#FF5F00]' />
          <div className='h-5 w-8 rounded-sm bg-[#009CDE]' />
        </div>
